...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2020 at 03:23 PM
...
--
-- Dumping data for table `tb_app_rf_sessions`
--

INSERT INTO `tb_app_rf_sessions` (`SESSION_ID`, `IP_ADDRESS`, `USER_AGENT`, `LAST_ACTIVITY`, `USER_DATA`) VALUES
('5aad114a7ff71297609ef6209e6220f4', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:72.0) Gecko/20100101 Firefox/72.0', 1581146718, '');

-- --------------------------------------------------------

--
-- Table structure for table `tb_mou_rf_jenisberkas`
--

CREATE TABLE `tb_mou_rf_jenisberkas` (
  `ID_JENISBERKAS` char(5) NOT NULL,
...
CREATE TABLE `tb_mou_rf_jenislembaga` (
  `ID_JENIS_LEMBAGA` char(3) NOT NULL,
...
CREATE TABLE `tb_mou_rf_kota` (
  `ID_KOTA` varchar(14) NOT NULL,
  `ID_PROVINSI` varchar(9) DEFAULT NULL,
...
--
-- Table structure for table `tb_mou_rf_mitra`
--

CREATE TABLE `tb_mou_rf_mitra` (
  `ID_LEMBAGA` char(6) NOT NULL,
  `ID_PROVINSI` varchar(9) DEFAULT NULL,
  `ID_JENIS_LEMBAGA` char(3) DEFAULT NULL,
  `ID_KOTA` varchar(14) DEFAULT NULL,
...
CREATE TABLE `tb_mou_rf_provinsi` (
  `ID_PROVINSI` varchar(9) NOT NULL,
  `ID_NEGARA` varchar(5) DEFAULT NULL,
...
CREATE TABLE `tb_mou_tr_berkas` (
  ...
  `ID_JENISBERKAS` char(5) DEFAULT NULL,
...
--
-- Table structure for table `tb_mou_tr_kerjasama`
--

CREATE TABLE `tb_mou_tr_kerjasama` (
  `ID_KERJASAMA` char(5) NOT NULL,
  `ID_BERKAS` char(5) DEFAULT NULL,
  `ID_PERWAKILAN_LEMBAGA` char(9) DEFAULT NULL,
  ...
  `UNIT_PENGELOLA_KERJASAMA` varchar(50) NOT NULL,
...
--
-- Table structure for table `tb_mou_tr_perwakilanmitra`
--

CREATE TABLE `tb_mou_tr_perwakilanmitra` (
  `ID_PERWAKILAN_LEMBAGA` char(9) NOT NULL,
  `ID_LEMBAGA` char(6) DEFAULT NULL,
  `NAMA_PERWAKILAN_LEMBAGA` varchar(50) NOT NULL,
  `JENIS_KELAMIN_PERWAKILAN_LEMBAGA` char(1) DEFAULT NULL,
...
--
-- Indexes for table `tb_mou_rf_jenisberkas`
--
ALTER TABLE `tb_mou_rf_jenisberkas`
  ADD PRIMARY KEY (`ID_JENISBERKAS`);
...
ALTER TABLE `tb_mou_rf_kota`
  ...
  ADD KEY `FK_RELATIONSHIP_13` (`ID_PROVINSI`);

--
-- Indexes for table `tb_mou_rf_mitra`
--
ALTER TABLE `tb_mou_rf_mitra`
...
ALTER TABLE `tb_mou_rf_provinsi`
  ...
  ADD KEY `FK_RELATIONSHIP_14` (`ID_NEGARA`);
...
ALTER TABLE `tb_mou_tr_berkas`
  ...
  ADD KEY `FK_RELATIONSHIP_3` (`ID_JENISBERKAS`);

--
-- Indexes for table `tb_mou_tr_kerjasama`
--
ALTER TABLE `tb_mou_tr_kerjasama`
  ADD PRIMARY KEY (`ID_KERJASAMA`),
  ADD KEY `FK_RELATIONSHIP_7` (`ID_PERWAKILAN_LEMBAGA`),
  ADD KEY `FK_RELATIONSHIP_8` (`ID_LEMBAGA`),
  ADD KEY `FK_RELATIONSHIP_9` (`ID_BERKAS`);

--
-- Indexes for table `tb_mou_tr_perwakilanmitra`
--
ALTER TABLE `tb_mou_tr_perwakilanmitra`
...
--
ALTER TABLE `tb_mou_rf_kota`
  ADD CONSTRAINT `FK_RELATIONSHIP_13` FOREIGN KEY (`ID_PROVINSI`) REFERENCES `tb_mou_rf_provinsi` (`ID_PROVINSI`);

--
-- Constraints for table `tb_mou_rf_mitra`
--
ALTER TABLE `tb_mou_rf_mitra`
...
--
ALTER TABLE `tb_mou_rf_provinsi`
  ADD CONSTRAINT `FK_RELATIONSHIP_14` FOREIGN KEY (`ID_NEGARA`) REFERENCES `tb_mou_rf_negara` (`ID_NEGARA`);

--
-- Constraints for table `tb_mou_tr_berkas`
--
ALTER TABLE `tb_mou_tr_berkas`
  ADD CONSTRAINT `FK_RELATIONSHIP_3` FOREIGN KEY (`ID_JENISBERKAS`) REFERENCES `tb_mou_rf_jenisberkas` (`ID_JENISBERKAS`);

--
-- Constraints for table `tb_mou_tr_kerjasama`
--
ALTER TABLE `tb_mou_tr_kerjasama`
  ADD CONSTRAINT `FK_RELATIONSHIP_7` FOREIGN KEY (`ID_PERWAKILAN_LEMBAGA`) REFERENCES `tb_mou_tr_perwakilanmitra` (`ID_PERWAKILAN_LEMBAGA`),
  ADD CONSTRAINT `FK_RELATIONSHIP_8` FOREIGN KEY (`ID_LEMBAGA`) REFERENCES `tb_mou_rf_mitra` (`ID_LEMBAGA`),
  ADD CONSTRAINT `FK_RELATIONSHIP_9` FOREIGN KEY (`ID_BERKAS`) REFERENCES `tb_mou_tr_berkas` (`ID_BERKAS`);

--
-- Constraints for table `tb_mou_tr_perwakilanmitra`
--
ALTER TABLE `tb_mou_tr_perwakilanmitra`
  ADD CONSTRAINT `FK_RELATIONSHIP_5` FOREIGN KEY (`ID_LEMBAGA`) REFERENCES `tb_mou_rf_mitra` (`ID_LEMBAGA`);
COMMIT;
